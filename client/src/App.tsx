      ...
      <BrowserRouter>
        ...
        <SmoothScrollWrapper>
          <Routes>
            ...
            <Route path="/booking/:packageId" element={<BookingPage packageId={""} price={""} />} />
            <Route path="/payment" element={<PaymentPage />} />
            <Route path="/payment-success" element={<PaymentSuccessPage />} />
            <Route path="/packages/:id" element={<ViewPackageDetails />} />
            <Route path="/packages/:id/details" element={<ViewPackageDetails />} />
            ...
            <Route path="/admin/destination/domestic" element={<DomesticDestination />} />
            <Route path="/admin/destination/international" element={<InternationalDestination />} />
            ...
            <Route path="/admin/custom-packages" element={<CustomPackageList />} />
            ...
            <Route path="/admin/locations/edit/:id" element={<EditLocationPage />} />
            <Route path="/admin/locations/create" element={<CreateLocationPage />} />

            {/* Protected and Public Auth Routes */}
