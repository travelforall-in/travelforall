...
const Sidebar = ({
  ...
  <div className="flex">
    ...
    >
      ...
      <nav className="flex flex-col gap-6">
        ...
        <motion.button
          ...
          transition={{ type: "spring", stiffness: 300 }}
          className="text-black flex items-center gap-2 hover:text-[#f1f2f3] hover:bg-[#087d71] px-3 py-2 rounded-md"
          onClick={onCustomPackageClick}
        >
          <PackagePlus size={20} /> {!isCollapsed && "Custom Package"}
        </motion.button>
      </nav>
    ...
    <main className={`${isCollapsed ? "ml-20" : "ml-64"} w-full p-8`}></main>
  </div>
);
