...
//   const handleApplyPreferences = (): void => {
//     toast({
...
//           {user ? (
//             <>
//               <div className="mt-4 px-3 py-2 text-sm font-semibold text-gray-700 uppercase">{user.firstName.charAt(0)}</div>
...
<DropdownMenuTrigger asChild>
    <Button className="rounded-full bg-primary text-white w-9 h-9 p-0 text-sm font-bold uppercase" variant="ghost">
      {user && user.name ? user.name.charAt(0) : 'A'}  {/* Default fallback 'A' */}
    </Button>
  </DropdownMenuTrigger>
