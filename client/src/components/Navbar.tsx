...
const Navbar: React.FC = () => {
  ...
  return (
    <header
      className={`fixed w-full bg-white/90 backdrop-blur-sm  shadow-sm transition-transform duration-300 ${
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-tight">
              <Link to="/" className="text-2xl font-bold text-primary">
                Travel<span className="text-secondary">ForAll</span>
              </Link>
              <span className="text-sm h-  text-gray-500">Dream to Departure</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/all-packages" className="hover:text-primary">
              Packages
            </Link>
            ...
            {user ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 mt-2">
                  ...
                  <DropdownMenuItem onClick={() => navigate("/my-packages")}>
                    My Packages
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white px-2 pt-2 pb-4 space-y-1">
          <Link to="/" className="block px-3 py-2 hover:bg-muted rounded">
            Home
          </Link>
          <Link
            to="/packages"
          ...
          <Link to="/about" className="block px-3 py-2 hover:bg-muted rounded">
            About
          </Link>
          <Link
            to="/contact"
